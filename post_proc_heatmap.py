...
def extract_patches(path, wsi_path, name, base_path, patch_size=256, min_val=-15, num_patches=25, get_patch_dict=False, shuffle=True, store_single_patches=True):
            ...
            if subfolder == "production":
                ...
                for r, d, f in os.walk(os.path.join(root, "raw/heat/Unspecified/{0}".format(name))):
                    ...
                    if isinstance(blockmap, str):
                        ...
                        # patch_sub_dict = extract_patches(blockmap_path, wsi_path, name, min_val=min_val, num_patches=num_patches)
                        patch_sub_dict = extract_patches(blockmap_path, wsi_path, name, base_path, min_val=min_val, num_patches=num_patches)
